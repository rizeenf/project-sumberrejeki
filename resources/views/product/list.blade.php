...
@section('content')
    <div class="content">
        ...
        <div class="button  d-flex flex-row justify-content-between">
            <a class="btn btn-success" href="{{ route('product.create') }}"> <i class="fa fa-plus"></i> Produk</a>
            <div class="importExport">
                <a class="btn btn-primary" href="javascript:void(0)" id="ProductImport"> <i class="fa fa-upload"></i><span>  Excel</span></a>
                <a class="btn btn-success" href="{{ route('product.export') }}"> <i class="fa fa-download"></i> <span>  Excel</span></a>
            </div>
        </div>
        <br>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('product.import') }}" name="ImportProduct" class="form-horizontal" method="POST" enctype="multipart/form-data">
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'subbrand', name: 'subbrand'},
            {data: 'competitor', name: 'competitor'},
    ...
    $('#ProductImport').click(function () {
        $('#modelHeading').html("Import Product");
