    ...
    <div class="formWrapper">
        ...
        @csrf
            <div class="form-group">
                <label for="name" class="col-sm-4 control-label mb-1 ">Kode Produk</label>
                <div class="col-sm-12">
                    <input type="text" class="form-control form-control-sm" name="code" placeholder="Kode Produk" value="">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-4 control-label mb-1">Nama Produk</label>
                <div class="col-sm-12">
                    <input type="text" class="form-control form-control-sm" name="name" placeholder="Nama Produk" value="" required="">
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="name" class="col-sm-4 control-label mb-1">Deskripsi Produk</label>
                <div class="col-sm-12">
                    <textarea name="desc" cols="30" rows="10" placeholder="Deskripsi Produk" class="form-control form-control-sm"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="name" class="col-sm-4 control-label mb-1">Foto Produk</label>
                <div class="col-sm-12">
                    <input type="file" class="form-control form-control-sm" name="photo" placeholder="Pilih Foto Produk" accept="image/*" >
                </div>
            </div>
