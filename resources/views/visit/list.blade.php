    ...
    <div class="content">
        ...
        <div class="button  d-flex flex-row justify-content-between">
            ...
            <div class="importExport">
                ...
                <a class="btn btn-success" href="{{ route('visit.export') }}"> <i class="fa fa-download"></i> <span> Export to Excel</span></a>
            </div>
        </div>
        ...
        <table class="table table-bordered data-table">
            <thead>
                <tr>
                    ...
                    <th>Person</th>
                    <th>Customer Terkunjungi</th>
                    <th>Gerai Terkunjungi</th>
                    <th>Total Foto Kunjugan</th>
    ...
    var table = $('.data-table').DataTable({
        ...
        buttons: [
            ...
            // },
            {
                ...
                title : 'Summary Visit Merchandaiser',
                exportOptions: {
                    columns: ':visible'
                }
        ...
        columns: [
            ...
            {data: 'custVisited', name: 'custVisited'},
            {data: 'outletVisited', name: 'outletVisited'},
            {data: 'photoVisited', name: 'photoVisited'},
