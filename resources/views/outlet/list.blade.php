...
@section('content')
    <div class="content">
        ...
        <div class="button  d-flex flex-row justify-content-between">
            <a class="btn btn-success" href="{{ route('outlet.create') }}"> <i class="fa fa-plus"></i> Gerai</a>
            <div class="importExport">
                <a class="btn btn-primary" href="javascript:void(0)" id="CustomerImport"> <i class="fa fa-upload"></i><span>  Excel</span></a>
                <a class="btn btn-success" href="{{ route('outlet.export') }}"> <i class="fa fa-download"></i> <span>  Excel</span></a>
            </div>
        </div>
        <br>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('outlet.import') }}" name="ImportCustomer" class="form-horizontal" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.deleteCustomer', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('outlet.store') }}"+'/'+customer_id,
