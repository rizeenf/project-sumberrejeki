...
<div class="formContainer">
    ...
    <div class="formWrapper">
        ...
        <form action="{{ route('outlet.update', ['outlet'=>$outlets->id]) }}" method="POST" class="formFlex" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <!-- DATA Gerai/OUTLET -->
            <div class="leftForm">
                <h4>Data Gerai</h4><br>
                <input type="hidden" name="Gerai_id" value="{{ $outlets->id }}">
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label mb-1 ">Kode Gerai</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="code" placeholder="Kode Gerai" value="{{ $outlets->code }}">
                    </div>
                </div>

                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label mb-1">Nama Gerai</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="name" placeholder="Nama Gerai/Outlet" value="{{ $outlets->name }}" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="phone_cust" placeholder="No. Telepon" value="{{ $outlets->phone }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="subarea" placeholder="Area" value="{{ $outlets->subarea }}">
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                    <label class="col-sm-4 control-label mb-1">Jenis Gerai</label>
                    <div class="col-sm-12">
                        <div class="form-check-inline">
                        <label class="form-check-label">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        @if ($outlets->branch_name == NULL)
                            <option>--- Pilih Cabang ---</option>
                            @foreach ($branches as $branch)
                            <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                            @endforeach
                        @else
                            <option value="{{ $outlets->branch_id }}">{{ $outlets->branch_name }}</option>
                            @foreach ($branches as $branch)
                            <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                            @endforeach
                        @endif
    ...
    <div class="formWrapper">
        ...
        <form action="{{ route('outlet.store') }}" method="POST" class="formFlex" enctype="multipart/form-data">
        @csrf
            <!-- DATA Gerai/OUTLET -->
            <div class="leftForm">
                <h4>Data Gerai</h4><br>
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label mb-1 ">Kode Gerai</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="code" placeholder="Kode Gerai" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label mb-1">Nama Gerai</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="name" placeholder="Nama Gerai/Outlet" value="" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label mb-1">Sub Area</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control form-control-sm" name="subarea" placeholder="Area" value="">
                    </div>
                </div>
