...
<div class="formContainer">
    <div class="formWrapper">
        <div class="d-flex flex-row gap-5 ">
            <h3>Detail {{ $customers->name }}</h3>
        </div>
        <form action="{{ route('customer.update', $customers->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control form-control-sm" name="name" placeholder="Nama Customer/Outlet" value="{{ $customers->name }}" maxlength="100" disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control form-control-sm" name="owner" placeholder="Nama Pemilik" value="{{ $customers->owner }}" maxlength="100" disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control form-control-sm" name="phone" placeholder="No. Telepon" value="{{ $customers->phone }}" maxlength="100" disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea name="address" required="" placeholder="Alamat" class="form-control form-control-sm" disabled>{{ $customers->address }}</textarea>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <select class="form-control form-control-sm" name='branch' disabled>
                    @if($customers->branch_id == NULL)
                        <option value="" >Tidak Terhubung Dengan Cabang</option>
                    @else
